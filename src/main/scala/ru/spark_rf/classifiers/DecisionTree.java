...
// by @vitux - https://github.com/vitux/java_decision_tree/blob/master/DecisionTree.java
...
public class DecisionTree extends AbstractClassifier {
    ...
    private double entropy(ArrayList<Integer> y) {
    ...
    @Override
    public DecisionTree deserialize(String s) {
        DecisionTree tree = new DecisionTree();
        tree.fillFromString(s);
        return tree;
    }
}
